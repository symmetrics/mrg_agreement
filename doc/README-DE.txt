...
Blocks (Identifier) muessen "symmetrics_business_terms"
und "symmetrics_revocation" heißen. 
...
*** C: Erstellt Blöcke "symmetrics_business_terms" und
        "symmetrics_revocation"
...
*** E: Prüfen Sie, ob in den Agreements die Blöcke "symmetrics_business_terms"
        und "symmetrics_revocation" via {{block}} Aufruf eingebunden werden und
        funktionieren.
